...
var StudentsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(auth_guard_1.AuthGuard), (0, common_1.Controller)('students')];
    ...
    var StudentsController = _classThis = /** @class */ (function () {
        ...
        StudentsController_1.prototype.list = function (q) { return this.service.list(q); };
        StudentsController_1.prototype.one = function (id) { return this.service.findOne(id); };
        StudentsController_1.prototype.create = function (d) { return this.service.create(d); };
        StudentsController_1.prototype.update = function (id, d) { return this.service.update(id, d); };
        StudentsController_1.prototype.remove = function (id) { return this.service.remove(id); };
