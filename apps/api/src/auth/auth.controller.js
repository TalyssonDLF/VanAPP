...
var cookie = { httpOnly: true, sameSite: 'lax', secure: process.env.NODE_ENV === 'production', maxAge: 7 * 24 * 60 * 60 * 1000, path: '/' };
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (dto, response) {
            return __awaiter(this, void 0, void 0, function () { var result; return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auth.register(dto)];
                    case 1:
                        result = _a.sent();
                        response.cookie('vanescolar_session', result.token, cookie);
        ...
        AuthController_1.prototype.login = function (dto, response) {
            return __awaiter(this, void 0, void 0, function () { var result; return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auth.login(dto)];
                    case 1:
                        result = _a.sent();
                        response.cookie('vanescolar_session', result.token, cookie);
                        return [2 /*return*/, result.user];
        ...
        AuthController_1.prototype.me = function (request) { return this.auth.getUser(request.user); };
        AuthController_1.prototype.logout = function (request, response) {
            return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auth.logout(request.user.sub)];
                    case 1:
                        _a.sent();
                        response.clearCookie('vanescolar_session', cookie);
                        return [2 /*return*/];
                }
            }); });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.HttpCode)(200), (0, common_1.Post)('login')];
        _me_decorators = [(0, common_1.UseGuards)(auth_guard_1.AuthGuard), (0, common_1.Get)('me')];
        _logout_decorators = [(0, common_1.UseGuards)(auth_guard_1.AuthGuard), (0, common_1.HttpCode)(204), (0, common_1.Post)('logout')];
